...
pub use contracts::{
    ...
    GoldenSampleGateDecision, GoldenSampleSelectionResult, GoldenSampleSelectorInput,
    KbRouterExcludedCandidate, KbRouterRetrievalTrace, KbRouterRuntimeRequest,
    KbRouterRuntimeResponse, KbRouterSelectedRule, KbRouterSelectionReason, KbRouterTaskType,
    KbRouterTokenBudget, ModelChannel, ModelConfigSummary, ModelRequest, ModelResponse,
    ProductWarning, PromptPackageRecord, PromptTextCompilationStatus, ScenePerformanceProjection,
